...
/**
 * ArCreditRetApi Class Doc Comment
 *
 * @category Class
 * @package  com_kingdee_service
 * @author   Swagger Codegen team
...
class ArCreditRetApi
{
     ...
     *
     * @param  \com_kingdee_service\data\entity\ArCreditRetSaveRequest $body body (required)
     *
     * @throws \com_kingdee_service\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com_kingdee_service\data\entity\SaveReply
     */
    public function arCreditRetSave($body)
    {
        $response = $this->arCreditRetSaveWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation arCreditRetSaveWithHttpInfo
     *
     * 收款退款单保存;收款退款单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07);1.0.11
     *
     * @param  \com_kingdee_service\data\entity\ArCreditRetSaveRequest $body (required)
     *
     * @throws \com_kingdee_service\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com_kingdee_service\data\entity\SaveReply, HTTP status code, HTTP response headers (array of strings)
     */
    public function arCreditRetSaveWithHttpInfo($body)
    {
        $returnType = '\com_kingdee_service\data\entity\SaveReply';
        $request = $this->arCreditRetSaveRequest($body);
    ...
    /**
     * Operation arCreditRetSaveAsync
     *
     * 收款退款单保存;收款退款单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07);1.0.11
     *
     * @param  \com_kingdee_service\data\entity\ArCreditRetSaveRequest $body (required)
     ...
     */
    public function arCreditRetSaveAsync($body)
    {
        return $this->arCreditRetSaveAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation arCreditRetSaveAsyncWithHttpInfo
     *
     * 收款退款单保存;收款退款单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07);1.0.11
     *
     * @param  \com_kingdee_service\data\entity\ArCreditRetSaveRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function arCreditRetSaveAsyncWithHttpInfo($body)
    {
        $returnType = '\com_kingdee_service\data\entity\SaveReply';
        $request = $this->arCreditRetSaveRequest($body);
    ...
    /**
     * Create request for operation 'arCreditRetSave'
     *
     * @param  \com_kingdee_service\data\entity\ArCreditRetSaveRequest $body (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function arCreditRetSaveRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling arCreditRetSave'
            );
        }

        $resourcePath = '/jdy/v2/arap/ar_credit_ret';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
