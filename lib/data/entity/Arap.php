 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Arap implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Arap';
    ...
    {
        $this->container['radio_field'] = isset($data['radio_field']) ? $data['radio_field'] : null;
    ...
    {
        return $this->container['radio_field'];
    }

    /**
     * Sets radio_field
     *
     * @param bool $radio_field radio_field
     *
     * @return $this
     */
    public function setRadioField($radio_field)
    {
        $this->container['radio_field'] = $radio_field;
